...
// 
namespace SoapWSSecurity.zmv92 {
    ...
    //[System.Web.Services.WebServiceBindingAttribute(Name="pubs_ssl_endpointSoap", Namespace="http://tempuri.org")]
    [System.Web.Services.WebServiceBindingAttribute(Name = "pubs_ssl_endpointSoap", Namespace = "http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd")]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(xml))]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(SqlParameter[]))]
    public class pubs_ssl_endpoint : System.Web.Services.Protocols.SoapHttpClientProtocol {

        public SqlSoapHeader.Security sqlSecurityValue;
        public SqlSoapHeader.sqlSession sqlSession;

        /// <remarks/>
        public pubs_ssl_endpoint() {
            string urlSetting = System.Configuration.ConfigurationSettings.AppSettings["SoapWSSecurity.zmv92.pubs_ssl_endpoint"];
            if ((urlSetting != null)) {
                this.Url = string.Concat(urlSetting, "");
            }
            else {
                this.Url = "https://zmv92/pubs_ssl/";
            }
        }
        ...
        [System.Web.Services.Protocols.SoapHeaderAttribute("sqlSecurityValue",  Direction = SoapHeaderDirection.In)]
        [System.Web.Services.Protocols.SoapHeaderAttribute("sqlSession", Direction = SoapHeaderDirection.In)]
