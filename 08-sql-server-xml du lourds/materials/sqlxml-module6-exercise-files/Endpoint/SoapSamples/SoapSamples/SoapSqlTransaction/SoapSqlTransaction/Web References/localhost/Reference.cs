...
// 
namespace SoapSqlTransaction.localhost {
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="pubs_endpointSoap", Namespace="http://tempuri.org")]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(xml))]
    [System.Xml.Serialization.XmlIncludeAttribute(typeof(SqlParameter[]))]
    public class pubs_endpoint : System.Web.Services.Protocols.SoapHttpClientProtocol {

        public SqlSoapHeader.sqlSession sqlSession;
        // to detect transaction change state
        public SqlSoapHeader.environmentChangeNotifications sqlChangeNotif;

        /// <remarks/>
        public pubs_endpoint() {
            string urlSetting = System.Configuration.ConfigurationSettings.AppSettings["SoapSqlTransaction.localhost.pubs_endpoint"];
            if ((urlSetting != null)) {
                this.Url = string.Concat(urlSetting, "");
            }
            else {
                this.Url = "http://localhost/pubs/";
            }
        }
        ...
        [System.Web.Services.Protocols.SoapHeaderAttribute("sqlChangeNotif", Direction = SoapHeaderDirection.InOut)]
