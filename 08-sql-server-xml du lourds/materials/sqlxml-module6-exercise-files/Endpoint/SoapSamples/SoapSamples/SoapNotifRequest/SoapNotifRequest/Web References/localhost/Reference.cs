...
// 
namespace SoapNotifRequest.localhost {
    ...
    public class pubs_endpoint : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public SqlSoapHeader.notificationRequest sqlNotif;

        /// <remarks/>
        public pubs_endpoint() {
            string urlSetting = System.Configuration.ConfigurationSettings.AppSettings["SoapNotifRequest.localhost.pubs_endpoint"];
            if ((urlSetting != null)) {
        ...
        [System.Web.Services.Protocols.SoapHeaderAttribute("sqlNotif", Direction = SoapHeaderDirection.In)]
