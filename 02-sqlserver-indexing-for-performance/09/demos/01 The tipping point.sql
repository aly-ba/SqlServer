...
--	120 SQL Server 2014
--	130 SQL Server 2016
-- Note: The compat mode DOES affect the tipping point. 
-- In this script we'll go between both the legacy CE and
-- the New CE. (CE = Cardinality Estimation model)

-- Let's start by changing our database to use the New CE
...
ALTER DATABASE [EmployeeCaseStudy]
		SET COMPATIBILITY_LEVEL = 110; -- LEGACY CE
GO
